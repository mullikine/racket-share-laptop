4497
((3) 0 () 13 ((q lib "file/ico.rkt") (q lib "file/unzip.rkt") (q lib "file/gunzip.rkt") (q lib "file/sha1.rkt") (q 10397 . 4) (q lib "file/gif.rkt") (q lib "file/glob.rkt") (q lib "file/zip.rkt") (q lib "file/resource.rkt") (q lib "file/tar.rkt") (q lib "file/gzip.rkt") (q lib "file/convertible.rkt") (q lib "file/cache.rkt")) () (h ! (equal) ((c def c (c (? . 0) q read-icos-from-exe)) q (17571 . 3)) ((c def c (c (? . 3) q sha1)) q (14641 . 3)) ((c def c (c (? . 1) q zip-directory-includes-directory?)) q (9079 . 5)) ((c def c (c (? . 6) q glob)) q (21680 . 6)) ((c def c (c (? . 0) q ico?)) q (17128 . 3)) ((c def c (c (? . 2) q gunzip-through-ports)) q (4842 . 4)) ((c def c (c (? . 1) q zip-directory-contains?)) q (8943 . 4)) ((c def c (c (? . 1) q make-exn:fail:unzip:no-such-entry)) c (? . 4)) ((c def c (c (? . 2) q gunzip)) q (4620 . 5)) ((c def c (c (? . 1) q read-zip-directory)) q (8689 . 3)) ((c def c (c (? . 0) q write-icos)) q (17673 . 7)) ((q def ((lib "file/untgz.rkt") untgz)) q (13820 . 16)) ((c def c (c (? . 0) q ico-format)) q (17409 . 3)) ((c def c (c (? . 1) q zip-directory-entries)) q (8849 . 3)) ((c def c (c (? . 1) q call-with-unzip-entry)) q (10157 . 5)) ((c def c (c (? . 3) q sha1-bytes)) q (14698 . 3)) ((c def c (c (? . 7) q zip-verbose)) q (7128 . 4)) ((c def c (c (? . 1) q make-filesystem-entry-reader)) q (8026 . 13)) ((c def c (c (? . 11) q convert)) q (2243 . 41)) ((c def c (c (? . 1) q exn:fail:unzip:no-such-entry?)) c (? . 4)) ((c def c (c (? . 9) q tar-gzip)) q (12306 . 18)) ((c def c (c (? . 0) q read-icos)) q (17478 . 3)) ((c def c (c (? . 5) q gif-state)) q (15332 . 3)) ((c def c (c (? . 8) q get-resource)) q (18611 . 13)) ((c def c (c (? . 5) q empty-gif-stream?)) q (15102 . 3)) ((c def c (c (? . 6) q in-glob)) q (21908 . 6)) ((c def c (c (? . 7) q zip)) q (5031 . 20)) ((c def c (c (? . 1) q zip-directory?)) q (8789 . 3)) ((c def c (c (? . 5) q gif-add-comment)) q (16700 . 4)) ((c def c (c (? . 5) q gif-stream?)) q (14896 . 3)) ((c def c (c (? . 5) q color?)) q (15224 . 3)) ((c def c (c (? . 5) q image-ready-gif-stream?)) q (14953 . 3)) ((c def c (c (? . 1) q path->zip-path)) q (10326 . 3)) ((c def c (c (? . 0) q ico-height)) q (17251 . 3)) ((c def c (c (? . 7) q zip->output)) q (6055 . 21)) ((c def c (c (? . 6) q glob-capture-dotfiles?)) q (22469 . 5)) ((c def c (c (? . 1) q exn:fail:unzip:no-such-entry)) c (? . 4)) ((c def c (c (? . 3) q hex-string->bytes)) q (14829 . 3)) ((c def c (c (? . 8) q write-resource)) q (19105 . 13)) ((c def c (c (? . 9) q tar->output)) q (11426 . 19)) ((c def c (c (? . 2) q inflate)) q (4943 . 4)) ((c def c (c (? . 5) q quantize)) q (16912 . 5)) ((c def c (c (? . 1) q struct:exn:fail:unzip:no-such-entry)) c (? . 4)) ((c def c (c (? . 0) q ico->argb)) q (18217 . 3)) ((c def c (c (? . 10) q gzip)) q (3930 . 5)) ((c def c (c (? . 1) q call-with-unzip)) q (7897 . 4)) ((c def c (c (? . 10) q deflate)) q (4417 . 6)) ((c def c (c (? . 5) q gif-colormap?)) q (15165 . 3)) ((c def c (c (? . 0) q ico-width)) q (17178 . 3)) ((c def c (c (? . 9) q tar)) q (10551 . 21)) ((c def c (c (? . 5) q dimension?)) q (15276 . 3)) ((c def c (c (? . 0) q ico->png-bytes)) q (18273 . 3)) ((c def c (c (? . 1) q unzip)) q (7214 . 13)) ((c def c (c (? . 5) q gif-end)) q (16823 . 3)) ((c def c (c (? . 6) q glob/c)) q (21614 . 2)) ((c def c (c (? . 12) q cache-file)) q (19694 . 28)) ((c def c (c (? . 0) q ico-depth)) q (17325 . 3)) ((c def c (c (? . 11) q prop:convertible)) q (0 . 41)) ((c def c (c (? . 10) q gzip-through-ports)) q (4098 . 9)) ((c def c (c (? . 0) q argb->ico)) q (18334 . 6)) ((c def c (c (? . 5) q gif-start)) q (15402 . 7)) ((c def c (c (? . 0) q replace-all-icos)) q (18089 . 4)) ((c def c (c (? . 5) q gif-add-control)) q (16135 . 11)) ((c def c (c (? . 3) q bytes->hex-string)) q (14760 . 3)) ((c def c (c (? . 1) q unzip-entry)) q (9271 . 18)) ((c def c (c (? . 0) q png-bytes->ico)) q (18548 . 3)) ((c def c (c (? . 0) q replace-icos)) q (17987 . 4)) ((q def ((lib "file/md5.rkt") md5)) q (14510 . 4)) ((c def c (c (? . 5) q image-or-control-ready-gif-stream?)) q (15022 . 3)) ((q def ((lib "file/untar.rkt") untar)) q (13130 . 16)) ((c def c (c (? . 5) q gif-add-loop-control)) q (16575 . 4)) ((c def c (c (? . 5) q gif-add-image)) q (15598 . 17)) ((c def c (c (? . 12) q cache-remove)) q (21090 . 11)) ((c def c (c (? . 6) q glob-match?)) q (22146 . 7)) ((c def c (c (? . 1) q exn:fail:unzip:no-such-entry-entry)) c (? . 4)) ((c def c (c (? . 11) q convertible?)) q (2185 . 3))))
value
prop:convertible
