480
((3) 0 () 2 ((c (? . 1) q pict-snip%) (q lib "pict/snip.rkt")) () (h ! (equal) ((c meth c (c (? . 0) q copy)) q (1925 . 2)) ((c meth c (c (? . 0) q get-extent)) q (189 . 17)) ((c def c (c (? . 1) q snipclass)) q (1985 . 2)) ((c meth c (c (? . 0) q get-pict)) q (141 . 2)) ((c def c (c (? . 1) q reader)) q (2028 . 2)) ((c constructor c (? . 0)) q (51 . 3)) ((c def c (? . 0)) q (0 . 3)) ((c meth c (c (? . 0) q draw)) q (989 . 23)) ((c meth c (c (? . 0) q write)) q (1837 . 3))))
class
pict-snip% : class?
  superclass: snip%
constructor
