3742
((3) 0 () 2 ((q lib "errortrace/stacktrace.rkt") (q lib "errortrace/errortrace-lib.rkt")) () (h ! (equal) ((q def ((lib "errortrace/errortrace-key.rkt") errortrace-key)) q (4961 . 2)) ((c def c (c (? . 0) q stacktrace/annotator@)) q (2389 . 2)) ((c def c (c (? . 1) q clear-profile-results)) q (625 . 2)) ((c sig-val c (c (? . 0) q stacktrace-imports^ with-mark)) q (3113 . 5)) ((c sig-val c (c (? . 0) q stacktrace^ annotate-top)) q (2662 . 4)) ((c def c (c (? . 1) q get-execute-counts)) q (956 . 2)) ((c def c (c (? . 0) q stacktrace@)) q (2361 . 2)) ((c sig-val c (c (? . 0) q stacktrace-imports^ profile-key)) q (3533 . 2)) ((c def c (c (? . 1) q test-coverage-info)) q (1436 . 4)) ((c sig-val c (c (? . 0) q stacktrace-imports^ initialize-test-coverage-point)) q (3456 . 3)) ((c def c (c (? . 1) q profiling-record-enabled)) q (204 . 4)) ((c def c (c (? . 1) q annotate-top)) q (2254 . 4)) ((c sig-val c (c (? . 0) q stacktrace^ st-mark-bindings)) q (2995 . 3)) ((c sig-val c (c (? . 0) q stacktrace/annotator-imports^ initialize-profile-point)) q (4465 . 5)) ((c def c (c (? . 1) q output-profile-results)) q (316 . 4)) ((c sig-val c (c (? . 0) q stacktrace-imports^ initialize-profile-point)) q (3659 . 5)) ((c sig-val c (c (? . 0) q stacktrace/annotator-imports^ profiling-enabled)) q (4367 . 4)) ((c def c (c (? . 1) q print-error-trace)) q (1535 . 4)) ((c def c (c (? . 1) q get-coverage)) q (888 . 2)) ((c form c (c (? . 0) q stacktrace-filter^)) q (4805 . 2)) ((c sig-val c (c (? . 0) q stacktrace-filter^ should-annotate?)) q (4848 . 4)) ((c sig-val c (c (? . 0) q stacktrace/annotator-imports^ profile-key)) q (4339 . 2)) ((c def c (c (? . 1) q annotate-covered-file)) q (1027 . 5)) ((c def c (c (? . 0) q stacktrace/filter@)) q (2427 . 2)) ((c def c (c (? . 1) q coverage-counts-enabled)) q (670 . 4)) ((c sig-val c (c (? . 0) q stacktrace^ make-st-mark)) q (2785 . 4)) ((c def c (c (? . 1) q make-errortrace-compile-handler)) q (1943 . 3)) ((c sig-val c (c (? . 0) q stacktrace/annotator-imports^ register-profile-done)) q (4691 . 4)) ((c sig-val c (c (? . 0) q stacktrace/annotator-imports^ register-profile-start)) q (4603 . 3)) ((c sig-val c (c (? . 0) q stacktrace-imports^ test-coverage-enabled)) q (3264 . 4)) ((c def c (c (? . 1) q annotate-executed-file)) q (1227 . 5)) ((c sig-val c (c (? . 0) q stacktrace^ st-mark-source)) q (2921 . 3)) ((c def c (c (? . 1) q profile-paths-enabled)) q (519 . 4)) ((c def c (c (? . 1) q errortrace-annotate)) q (2188 . 3)) ((c form c (c (? . 0) q stacktrace/annotator-imports^)) q (3999 . 2)) ((c form c (c (? . 0) q stacktrace-imports^)) q (3069 . 2)) ((c sig-val c (c (? . 0) q stacktrace-imports^ register-profile-done)) q (3885 . 4)) ((c sig-val c (c (? . 0) q stacktrace-imports^ profiling-enabled)) q (3561 . 4)) ((c def c (c (? . 1) q profiling-enabled)) q (106 . 4)) ((c def c (c (? . 0) q stacktrace/annotator/filter@)) q (2462 . 2)) ((c def c (c (? . 1) q error-context-display-depth)) q (1644 . 4)) ((c def c (c (? . 1) q instrumenting-enabled)) q (0 . 4)) ((c sig-val c (c (? . 0) q stacktrace/annotator-imports^ test-coverage-point)) q (4053 . 5)) ((c def c (c (? . 1) q errortrace-error-display-handler)) q (2033 . 5)) ((c sig-val c (c (? . 0) q stacktrace/annotator-imports^ with-mark)) q (4188 . 5)) ((c sig-val c (c (? . 0) q stacktrace^ annotate)) q (2543 . 4)) ((c def c (c (? . 1) q execute-counts-enabled)) q (780 . 4)) ((c form c (c (? . 0) q stacktrace^)) q (2507 . 2)) ((c sig-val c (c (? . 0) q stacktrace-imports^ register-profile-start)) q (3797 . 3)) ((c sig-val c (c (? . 0) q stacktrace-imports^ test-covered)) q (3370 . 3)) ((c def c (c (? . 1) q errortrace-compile-handler)) q (1761 . 6)) ((c def c (c (? . 1) q get-profile-results)) q (428 . 3))))
parameter
