4240
((3) 0 () 11 ((q lib "games/cards.rkt") (c (? . 0) q table<%>) (c (? . 0) q card<%>) (q 522 . 10) (q 4286 . 7) (q 3933 . 9) (q 5169 . 3) (q 3761 . 5) (q 4614 . 5) (q 5405 . 5) (q 5039 . 3)) () (h ! (equal) ((c meth c (c (? . 1) q unhilite-region)) c (? . 9)) ((c meth c (c (? . 2) q face-down?)) q (7142 . 2)) ((c meth c (c (? . 1) q card-location)) q (4877 . 3)) ((c meth c (c (? . 2) q get-value)) q (7462 . 2)) ((c meth c (c (? . 2) q card-width)) q (6884 . 2)) ((c meth c (c (? . 1) q move-cards-to-region)) q (3580 . 5)) ((c meth c (c (? . 2) q get-suit)) q (7417 . 2)) ((c def c (c (? . 0) q make-region)) c (? . 3)) ((c meth c (c (? . 2) q card-height)) q (6950 . 2)) ((c meth c (c (? . 2) q snap-back-after-move)) q (7740 . 4)) ((c def c (? . 2)) q (6851 . 2)) ((c def c (c (? . 0) q region?)) c (? . 3)) ((c def c (c (? . 0) q region-interactive-callback)) q (1928 . 4)) ((c meth c (c (? . 2) q face-down)) q (7098 . 2)) ((c def c (c (? . 0) q region-callback)) c (? . 3)) ((c meth c (c (? . 1) q remove-cards)) q (2924 . 3)) ((c meth c (c (? . 2) q stay-in-region)) q (8004 . 4)) ((c meth c (c (? . 1) q set-status)) q (6186 . 3)) ((c meth c (c (? . 1) q rotate-cards)) c (? . 4)) ((c def c (c (? . 0) q region)) c (? . 3)) ((c meth c (c (? . 1) q begin-card-sequence)) c (? . 6)) ((c meth c (c (? . 1) q move-card)) q (3022 . 5)) ((c def c (c (? . 0) q region-h)) c (? . 3)) ((c meth c (c (? . 2) q flip)) q (7017 . 2)) ((c meth c (c (? . 1) q add-scribble-button)) q (6587 . 7)) ((c def c (? . 1)) q (2049 . 3)) ((c meth c (c (? . 1) q set-double-click-action)) q (5724 . 3)) ((c meth c (c (? . 1) q flip-cards)) c (? . 7)) ((c meth c (c (? . 2) q user-can-move)) q (7623 . 4)) ((c def c (c (? . 0) q set-region-callback!)) c (? . 3)) ((c meth c (c (? . 1) q table-width)) c (? . 10)) ((c meth c (c (? . 1) q set-button-action)) q (5540 . 5)) ((c meth c (c (? . 2) q user-can-flip)) q (7506 . 4)) ((c meth c (c (? . 1) q pause)) q (5948 . 3)) ((c meth c (c (? . 2) q get-suit-id)) q (7371 . 2)) ((c meth c (c (? . 2) q rotate)) q (7190 . 3)) ((c meth c (c (? . 2) q snap-back-after-regions)) q (7869 . 4)) ((c def c (c (? . 0) q region-y)) c (? . 3)) ((c meth c (c (? . 1) q add-region)) q (5270 . 3)) ((c meth c (c (? . 2) q copy)) q (8371 . 2)) ((c meth c (c (? . 1) q remove-region)) q (5336 . 3)) ((c meth c (c (? . 1) q animated)) q (6014 . 4)) ((c meth c (c (? . 1) q cards-face-up)) c (? . 5)) ((c def c (c (? . 0) q region-w)) c (? . 3)) ((c def c (c (? . 0) q make-background-region)) q (1209 . 11)) ((c meth c (c (? . 1) q rotate-card)) c (? . 4)) ((c meth c (c (? . 2) q dim)) q (8274 . 4)) ((c def c (c (? . 0) q set-region-interactive-callback!)) q (1682 . 6)) ((c meth c (c (? . 1) q stack-cards)) q (4780 . 3)) ((c meth c (c (? . 1) q add-cards-to-region)) q (2660 . 5)) ((c meth c (c (? . 1) q card-face-down)) c (? . 5)) ((c meth c (c (? . 2) q orientation)) q (7307 . 2)) ((c meth c (c (? . 1) q set-single-click-action)) q (5836 . 3)) ((c def c (c (? . 0) q make-deck)) q (172 . 2)) ((c meth c (c (? . 2) q face-up)) q (7056 . 2)) ((c meth c (c (? . 1) q end-card-sequence)) c (? . 6)) ((c def c (c (? . 0) q make-button-region)) q (883 . 9)) ((c meth c (c (? . 1) q card-face-up)) c (? . 5)) ((c meth c (c (? . 1) q flip-card)) c (? . 7)) ((c meth c (c (? . 1) q remove-card)) q (2839 . 3)) ((c meth c (c (? . 1) q card-to-front)) c (? . 8)) ((c def c (c (? . 0) q struct:region)) c (? . 3)) ((c def c (c (? . 0) q region-label)) c (? . 3)) ((c def c (c (? . 0) q shuffle-list)) q (423 . 4)) ((c meth c (c (? . 1) q card-to-back)) c (? . 8)) ((c def c (c (? . 0) q make-table)) q (0 . 5)) ((c meth c (c (? . 1) q hilite-region)) c (? . 9)) ((c meth c (c (? . 2) q home-region)) q (8142 . 4)) ((c def c (c (? . 0) q make-card)) q (217 . 6)) ((c meth c (c (? . 1) q create-status-pane)) q (6121 . 2)) ((c def c (c (? . 0) q region-x)) c (? . 3)) ((c meth c (c (? . 1) q move-cards)) q (3143 . 11)) ((c meth c (c (? . 1) q add-cards)) q (2227 . 11)) ((c meth c (c (? . 1) q all-cards)) q (4971 . 2)) ((c meth c (c (? . 1) q table-height)) c (? . 10)) ((c meth c (c (? . 1) q add-card)) q (2107 . 5)) ((c meth c (c (? . 1) q add-help-button)) q (6257 . 9)) ((c meth c (c (? . 1) q cards-face-down)) c (? . 5))))
procedure
